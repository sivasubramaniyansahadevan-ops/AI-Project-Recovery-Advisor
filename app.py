...
Note: The full PDF report includes visual charts and can be downloaded from ProjectRescue AI.
...
gmail_url = (
    ...
    f"&su=ProjectRescue AI Report - {urllib.parse.quote(result_row['project_name'])}"
    f"&body={encoded_text}"
)
